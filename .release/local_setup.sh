...
_colcon_prefix_sh_COLCON_CURRENT_PREFIX="/home/zyjiang/rviz/rviz/install"
...
_colcon_ordered_packages="$($_colcon_python_executable "$_colcon_prefix_sh_COLCON_CURRENT_PREFIX/_local_setup_util.py" --merged-install)"
...
for _colcon_package_name in $_colcon_ordered_packages; do
  ...
  COLCON_CURRENT_PREFIX="${_colcon_prefix_sh_COLCON_CURRENT_PREFIX}"
